...
namespace DiscApi.Services.Implements
{
    public class ProductService : IProductService
    {
        ...
        public async Task<(List<ProductDTORespone> Products, int Total)> ShowListAsync(
                                                                         string name ,
                                                                         int idType ,
                                                                         int idCategory ,
                                                                         int index ,
                                                                         int size )
        {
            ...
            catch (Exception ex)
            {
                ...
                return (Products: new List<ProductDTORespone>(), Total: 0);
            }
        }
        public async Task<List<ProductDTORespone>> GetProductDetail(int id)
        {
            try
            {
